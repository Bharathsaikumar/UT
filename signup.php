                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="signupdb.php" method="post">
                            <h3 class="text-center " style="color:#081a30;">Sign Up</h3>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" name="sid" id="username" class="form-control">
                            </div>
                             <div class="form-group">
                                <label for="username">Find My School:</label><br>
                                <input type="text" name="school" id="username" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                     <input type="submit" name="submit" class="btn btn-info btn-md form-control bg-success" value="Sign Up">
                            </div>
                            <div class="form-group">
                                     <button  name="account" class="btn btn-info btn-md form-control bg-primary"><a href="index.php" style="color:white;">Login</a></button>
                            </div>
